...
import { communitySigner, communityProvider } from './utils'
import { ethers } from 'ethers'

/**
 *  V0
 */
export const withdrawFundsV0 = async (revPathAddress: string, walletAddress: string, isERC20?: keyof typeof tokenList) => {
